...
// The devices, the limits and coldLevel() all come from the shared block below,
// which is byte-identical here, in the alarm script and in the change gate.
// Nothing outside that block may carry a threshold of its own: that is exactly
// what let the gate drift to 7 and -16 while the board rendered 10 and -12.
